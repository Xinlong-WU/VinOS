...
void molloc_test()
{
    ...
    printPageInfo(_get_malloc_table(_get_page_memory_byIndex(2))+800, 20);
    printf("memory usage ==> %d\n", _get_memory_usage_of_malloc(_get_malloc_table(_get_page_memory_byIndex(2))));
